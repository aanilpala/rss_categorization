...
public class Time {
	...
	public static long an_hour_scaled = 60*60*1000 / scaling_factor;
	public static long a_day_scaled = 24*60*60*1000 / scaling_factor;
	
	public static long an_hour = 60*60*1000;
