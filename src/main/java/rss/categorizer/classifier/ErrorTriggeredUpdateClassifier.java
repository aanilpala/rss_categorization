...
public class ErrorTriggeredUpdateClassifier {
	...
	private static Integer after_update = 300;
	    ...
	    public static void main(String[] args) {
			...
			NaiveBayesModel nbm;
			Double accuracy_since_last_update = -1.0;
			ArrayList<Double> arr = new ArrayList<Double>();
			
			int correct_count = 0;
			int count = 0;
			
			int correct_count_since_last_update = 0;
			int count_since_last_update = 0;
...
//---------------------------------------------------
		...
		//			System.out.println("accuracy since last update: " + accuracy_since_last_update);
					...
					System.out.println("ReTraining" + " at " + count);
					// setup nbm
					// timestamp, labeledpoint, label_representation
					...
					correct_count_since_last_update = 0;
					count_since_last_update = 0;
					
					for(int ctr2 = 0; tuple_ptr < tuple_count && ctr2 < after_update; ctr2++) {
						...
						if(prediction == label_rep) {
							correct_count++;
							correct_count_since_last_update++;
						}
						count++;
						count_since_last_update++;
