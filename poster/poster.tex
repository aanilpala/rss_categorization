...
The initial traing size of 600 is used for this model update method. For the incremental model, The initial traing size of 600 is used for this model update method. Dampening factor is simply  the value of the learning rate function subtracted by 1. Dampening factor is simply  the value of the learning rate function subtracted by 1.  As for the learning rate function, we used abs(arctan(x)/(pi/2)) This is because we want learning rate values between 1 and 0 which converges to 0 as the error gets smaller and converges to 1 as the error gets infinitely high.
 \end{multicols}
